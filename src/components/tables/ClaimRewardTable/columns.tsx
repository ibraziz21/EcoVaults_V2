...
const sourceIcons: Record<string, string> = {
  ...
  'Morpho Blue': '/protocols/morpho-icon.png', // SA path
...
export const ClaimableRewardColumns: ColumnDef<ClaimableReward>[] = [
  ...
  },
  {
    ...
    cell: ({ row, table }) => {
      ...
      const priceFn =
        typeof meta.priceUsdForSymbol === 'function'
          ? meta.priceUsdForSymbol
          : undefined
  ...
  },
  {
    ...
    cell: ({ row, table }) => {
      ...
      const onClaim = meta.onClaim as
        ...
        | undefined
      const isClaiming =
        typeof meta.isClaiming === 'function' ? meta.isClaiming(row.original) : false
      ...
      return (
        <Button
          title="Claim"
          className="bg-[#376FFF] hover:bg-[#2F5DD1] rounded-full px-3"
          onClick={handleClaim}
