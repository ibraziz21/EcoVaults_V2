// src/components/tables/VaultsTable/index.tsx  (VaultsTable)
'use client'
      ...
      <div className="flex justify-between items-center mx-5">
        ...
        <div className="flex items-center bg-[#F3F4F6] rounded-full px-2 h-full">
          <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M9.63457 9.71L11.95 11.95M11.2033 5.97667C11.2033 8.86328 8.86328 11.2033 5.97667 11.2033C3.09006 11.2033 0.75 8.86328 0.75 5.97667C0.75 3.09006 3.09006 0.75 5.97667 0.75C8.86328 0.75 11.2033 3.09006 11.2033 5.97667Z"
              stroke="#4B5563"
              strokeWidth="1.5"
              strokeLinecap="round"
            />
          ...
          <input
            type="text"
            className="outline-none p-1 text-[12px] bg-transparent"
